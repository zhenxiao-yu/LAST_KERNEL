...
namespace Kamgam.UIToolkitScriptComponents
{
    ...
    /// </summary>
    [AddComponentMenu("UI Toolkit/Scripts/Components/UI Change Vector3Int Handler")]
    public class UIChangeEventVector3IntHandler : UIChangeEventBaseHandler<Vector3Int> {}
}
#endif
