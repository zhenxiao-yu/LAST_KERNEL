...
#endif
    {
        public const string AssetName = "UI Toolkit Sound Effects";
        public const string Version = "1.0.3";
        public const string Define = "KAMGAM_UITOOLKIT_SOUND_EFFECTS";
        public const string ManualUrl = "https://kamgam.com/unity/UIToolkitSoundEffects.pdf";
        public const string AssetLink = "https://kamgam.com/unity-assets/uitoolkit-sound-effects-315956";

        private static string _assetRootPathDefault = "Assets/Kamgam/UIToolkitSoundEffects/";
        ...
        public static string ExamplePath = AssetRootPath + "Examples/EventsDemo/EventsDemo.unity";
        public static string ExampleLayoutPath = AssetRootPath + "Examples/EventsDemo/EventsDemo.uxml";
        ...
        public static void OpenExample()
        {
            EditorApplication.delayCall += () => 
            {
                ...
                var layout = AssetDatabase.LoadAssetAtPath<UnityEngine.Object>(ExampleLayoutPath);
