...
namespace Kamgam.UIToolkitGlow
{
    ...
    public class BlobAnimation : GlowAnimation
    {
        ...
        public override void CopyValuesFrom(IGlowAnimation source)
        {
            ...
            var typedSource = source as BlobAnimation;
            ...
            Dictionary<ushort, ushort> outerToInnerIndices)
        {
            ...
            for (int i = 0; i < oCount; i++)
            {
                ...
                float sinClockWise = Mathf.Sin(progressCW * 2f * Mathf.PI * Frequency + _progress);
                float displacement = SinusUtils.ApplySinusMode(Scale * sinClockWise, _sinusMode);
