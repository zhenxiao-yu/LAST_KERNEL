...
namespace Kamgam.UIToolkitScriptComponents
{
    ...
    /// </summary>
    [AddComponentMenu("UI Toolkit/Scripts/Components/UI Change Vector2Int Handler")]
    public class UIChangeEventVector2IntHandler : UIChangeEventBaseHandler<Vector2Int> {}
}
#endif
