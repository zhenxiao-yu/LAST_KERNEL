...
namespace Kamgam.UIToolkitScriptComponents
{
    public class Logger
    {
        ...
        public const string Prefix = "UIToolkitScriptComponents: ";
        public static LogLevel CurrentLogLevel = LogLevel.Warning;
		
		public const string DisableInfoMsg = "\nYou can change the verbosity of logs in the Settings under Tools > UI Toolkit Script Components > Settings : LogLevel";
        ...
        public static void Log(string message)
        {
            ...
            if(IsLogLevelVisible(LogLevel.Log))
                Debug.Log(Prefix + message + DisableInfoMsg);
        }
        ...
        public static void LogWarning(string message)
        {
            ...
            if (IsLogLevelVisible(LogLevel.Warning))
                Debug.LogWarning(Prefix + message + DisableInfoMsg);
        }
        ...
        public static void LogError(string message)
        {
            ...
            if (IsLogLevelVisible(LogLevel.Error))
                Debug.LogError(Prefix + message + DisableInfoMsg);
        }
