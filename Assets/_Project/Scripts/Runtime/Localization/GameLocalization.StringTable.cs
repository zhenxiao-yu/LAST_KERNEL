...
namespace Markyu.LastKernel
{
    public static partial class GameLocalization
    {
        private static readonly Dictionary<string, LocalizedTextEntry> TextEntries = new()
        {
            ...
            ["hud.time"]           = L("TIME",    "时间",    "時間",    "時間",    "시간",    "TEMPS",   "ZEIT",    "TIEMPO"),
            ["hud.assets"]         = L("ASSETS",  "储备",    "儲備",    "資源",    "자원",    "ACTIFS",  "GÜTER",   "ACTIVOS"),
            ["hud.breach"]         = L("BREACH",  "侵入",    "侵入",    "侵攻",    "침공",    "BRÈCHE",  "ANGRIFF", "BRECHA"),
