...
namespace Markyu.FortStack
{
    ...
    public static class GameLocalization
    {
        ...
        private static readonly Dictionary<string, LocalizedTextEntry> TextEntries = new()
        {
            ...
            ["daycycle.dayEndedBody"] = new("居民们需要补充口粮。", "Your residents need rations."),
            ...
            ["daycycle.dayStartedBody"] = new("殖民节点已重新联机。", "Colony links are back online."),
            ["daycycle.dayStartedAction"] = new("启动新一天", "Start New Day"),
            ["daycycle.gameOverTitle"] = new("聚落失守", "Settlement Lost"),
            ["daycycle.gameOverBody"] = new("你已经没有任何幸存居民了。", "You have no surviving residents left."),
