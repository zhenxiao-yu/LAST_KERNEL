...
#endif
    public class UITKSetFlexDirection : FsmStateAction
    {
        [RequiredField]
        ...
        [ObjectType(typeof(FlexDirection))]
        public FsmEnum FlexDirection;
        ...
        void setAttribute()
        {
            if (VisualElement.TryGetVisualElement(out var element))
            {
                ...
                {
                    element.ResetFlexDirection();
                }
                else
                {
                    element.SetFlexDirection((FlexDirection)FlexDirection.Value);
                }
            }
        }
    }
