...
#endif
    public class UITKGetContentContainer : FsmStateAction
    {
        [RequiredField]
        ...
        public FsmObject StoreContentContainer;
        ...
        public override void OnEnter()
        {
            ...
            {
                StoreContentContainer.SetResultElement(element.GetContentContainer(), ReuseStoreVariable);
            }
