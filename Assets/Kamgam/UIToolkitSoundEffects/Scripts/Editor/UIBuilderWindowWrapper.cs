...
namespace Kamgam.UIToolkitSoundEffects
{
    ...
    public class UIBuilderWindowWrapper
    {
        ...
        public VisualElement GetAttributesFoldoutContent()
        {
            if (RootVisualElement == null)
                return null;
            
            var attributes = RootVisualElement.Q<VisualElement>(name: "inspector-attributes-foldout");
            if (attributes == null)
                return null;
            
            var content = attributes.Q<VisualElement>(name: "unity-content");
            return content;
        }
