            ...
            if (currentRenderPipline != createdForRenderPipleline)
            {
                ...
                var materialPaths = new Dictionary<string, MaterialInfo>
                {
                      { Installer.AssetRootPath + "Examples/Materials/Staff.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.Default, HexToColor("FFFFFF"), "be9b0b991481ef34c97e6c39851b1ec0" ) }
                     ,{ Installer.AssetRootPath + "Examples/Materials/StaffGlow.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.UnlitTransparent, HexToColor("FFFFFF"), "be9b0b991481ef34c97e6c39851b1ec0" ) }
                    ,{ Installer.AssetRootPath + "Examples/Materials/SwordBlade.mat",
                        new MaterialInfo( MaterialInfo.ShaderType.Default, HexToColor("FFFFFF"), "90b2d39d52656df4d945d80257cab85d" ) }
