Shader "Kamgam/UIToolkit/URP/Pixelation"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float2 pixelSize = _PixelSize / 500;
                ...
                float2 pixelatedUV = round((normalizedTiledUV * delta) / pixelSize) * pixelSize;
                float2 tiledUV = uvMin + pixelatedUV;
                
                fixed4 col = tex2Dlod(_MainTex, float4(tiledUV, 0, 0)) * i.color * _Color;
                col.a *= _Opacity;
